...
* **Auror Core Version(s)** - is it a regression?
* **Auror plugins in use** - is this a problem with pure Auror only, or with some plugin?
...
* Search [GitHub](https://github.com/globocom/auror-core/pulls) for an open or closed Pull Request that relates to your submission. You don't want to duplicate effort.
